...
<div class="header">
  <p>Bienvenido a SAAP <strong><?php echo $userDetails->name; ?></strong></p>
  <div class="header-right">
    <a href="../empleados.php">Empleados</a>
    <a href="../lugares.php">Cantidad de Parqueaderos</a>
    <a href="../registro usuarios.php">Usuarios</a>
    ...
    <a href="logout.php"><img src="../img/boton.png" width="30" height="30" alt="Salir"/></a>
  </div>
</div>
<body>
