...
<input type="text" name="nameReg" autocomplete="off" required="required"/>
<label>Correo</label>
<input type="text" name="emailReg" autocomplete="off" required="required"/>
<label>Nombre de usuario</label>
<input type="text" name="usernameReg" autocomplete="off" required="required"/>

<label>Password</label>
<input type="password" name="passwordReg" autocomplete="off" required="required"/>
