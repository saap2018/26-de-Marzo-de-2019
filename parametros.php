...
mysql_select_db($database_prueba, $prueba);
$query_Recordset1 = "SELECT cantidad FROM cantidaddeparqueaderos";
...
<form id="form1" name="form1" method="POST" action="parametrizar.php">
  
</p>
Cantidad de parqueaderos
<label for="textfield"></label>
    <input name="numero" type="text" disabled="disabled" id="textfield" value="<?php echo $row_Recordset1['cantidad']; ?>" />
